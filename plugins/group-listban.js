let handler = async (m, { conn, isOwner }) => {
    ...
    let users2 = Object.entries(global.db.data.users).filter(user => user[1].banned && user[0].startsWith('62'))
    let users = Object.entries(global.db.data.users).filter(user => user[1].banned && !user[0].startsWith('62'))
